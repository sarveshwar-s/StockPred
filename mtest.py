...
# dates = []
# prices = []
# api_url = "https://financialmodelingprep.com/api/v3/historical-price-full/aapl?from=2018-12-01&to=2020-01-24"
...
# yes_pred = prediction_close(dates,prices,[[20200124]])
...
df = pd.read_csv('mothersumi2.csv')
print(df)
infydate = []
indate=[]
infyprice = []
